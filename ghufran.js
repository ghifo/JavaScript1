...
x = 21; //const x = 21;     //The output is error, I can't use initialization, I have to use definition.
...
console.log(
  'We can use console.log to check if the values are equal or not, and if one is greater or less than the other',
);
